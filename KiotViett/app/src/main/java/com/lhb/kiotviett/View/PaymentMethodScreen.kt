    ...
    Scaffold(
        ...
        Column(
           ...
           LazyColumn {
               item {
                   Column(
                       ...
                       Row(
                           ...
                           Text(text = totalAmount.toString(), fontSize = 18.sp, color = Color(0xff005595), fontWeight = FontWeight.Bold)
                       }
                       Divider(color = Color.LightGray, thickness = 0.5.dp, modifier = Modifier.fillMaxWidth())
                       Row(
                           modifier = Modifier
                           ...
                           Text(text = totalAmount.toString(), fontSize = 18.sp, color = Color(0xff303030), fontWeight = FontWeight.Bold)
                       }
                   }
               }
               item{
               ...
               item {
                   ItemCash(totalAmount)
                   ItemPayOnline(totalAmount, "Thẻ")
                   ItemPayOnline(totalAmount, "Chuyển khoản")
               }
               item { 
